...
class EnterPinScreen extends StatelessWidget {
  ...
  final PinController pinController = Get.find();  // Retrieve the existing instance
  ...
  Widget build(BuildContext context) {
    ...
    final String route = arguments['route'] ?? 'no_route';
            ...
            KeyPadButtonWidget(
              onTap: (digit) {
                if (digit == 'x') {
                  ...
                  pinController.isPinMatchNextScreen(route);
                } else {
